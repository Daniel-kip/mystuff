...
CREATE DATABASE IF NOT EXISTS deldeltech_db;
USE deldeltech_db;
...
VALUES ('System Administrator', 'admin@deltech.com', '8hJv7Kk2MnBpQwE1xZ3RtY6uI9oP0aL4cVbN7mGsDfXhC5jWqTzYr', 's9F2kL8pQ1mN6rT3wX7zY4bV5cM8nB0q', 'Admin');

-- Insert sample user
INSERT INTO auth_users (full_name, email, password_hash, salt, role) 
VALUES ('Test User', 'user@deltech.com', '6tG5hJ2kL9pQ1wE4rT7yU8iO3pA5sD2fG', 'p3L8kQ2mN6rT9wX1zY4bV7cM0nB3qS5t', 'User');
